 ...
 * children: ["ssr"] } }`. Alchemy supplies its host plugin. For standalone Vite,
 * configure a local workerd host separately, guarded by
 * `ALCHEMY_CLOUDFLARE_VITE_INJECTED !== "1"` to avoid starting a second host.
 */
