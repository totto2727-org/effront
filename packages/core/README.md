...
`src/entry.effront.tsx` directly exports the application definition.
...
The Vite integration transforms the shared application definition for each execution environment.
