...
It covers typed KV bindings reaching HTML and Server Functions, HEAD handling, hydration and navigation.
...
The Alchemy adapter's colocated tests protect Vite graph composition and SSR output layout without registering another host.
