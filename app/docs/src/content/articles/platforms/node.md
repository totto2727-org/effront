...
ナビゲーションやカウンターなど一画面の構成を超える機能は [Alchemy Basic](https://github.com/totto2727-org/effront/tree/main/examples/alchemy) を参照してください。以前の高機能な Node.js アプリケーションは[サーバーテスト専用の fixture](https://github.com/totto2727-org/effront/tree/main/tests/e2e-server/fixtures/node)として保持しています。
